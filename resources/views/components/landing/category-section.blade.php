<section class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 mb-20">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        @php
            // Kita definisikan datanya di sini biar rapi
            // type: 'custom' buat yang ada gradient-nya, 'image' buat sisanya
            $categories = [
                [
                    'title' => 'Destinations', 
                    'type' => 'custom', 
                    'icon' => 'map-pin' // Nanti kita pake SVG
                ],
                [
                    'title' => 'Culinary', 
                    'type' => 'image', 
        ...
        @foreach($categories as $item)
            <div class="bg-white rounded-2xl shadow-xl p-6 flex flex-col items-center justify-center gap-4 transition-transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer group h-[160px]">
                ...
                @if($item['title'] === 'Destinations')
                    ...
                    <div class="w-14 h-14 rounded-2xl bg-gradient-to-b from-[#47b6c2] to-[#5dd2de] flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition">
