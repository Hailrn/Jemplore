    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:block lg:w-1/2 relative bg-gray-900">
            ...
            <div class="absolute bottom-0 left-0 p-12 text-white z-10">
                <h2 class="text-4xl font-bold mb-4 leading-tight">Discover the Hidden Beauty<br>of Jember</h2>
                <p class="text-lg text-gray-100 max-w-md leading-relaxed">
                    Join our community to explore destinations, book packages, and manage your events easily.
                </p>
            </div>
        </div>
